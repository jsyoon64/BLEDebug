...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
            Toast.makeText(this, R.string.no_bt_support, Toast.LENGTH_SHORT).show();
            finish();
        }
    ...
    protected void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this,
                    ...
                    Const.MY_PERMISSIONS_REQUEST_GPS);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Const.REQUEST_ENABLE_BT && resultCode == Activity.RESULT_CANCELED) {
            finish();
            return;
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        switch (requestCode) {
            case Const.MY_PERMISSIONS_REQUEST_GPS: {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (deviceName != null && deviceName.length() > 0)
                ...
                viewHolder.deviceName.setText(R.string.empty_device_name);
